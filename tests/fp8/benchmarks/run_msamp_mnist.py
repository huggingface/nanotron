...
def main():
    ...
    parser.add_argument("--enable-msamp", action="store_true", default=True, help="enable MS-AMP")
    parser.add_argument("--opt-level", type=str, default="O2", help="MS-AMP optimization level")
