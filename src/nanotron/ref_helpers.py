...
from nanotron.optim.ref_optimizer_from_gradient_accumulator import (
...
def init_optimizer_and_grad_accumulator(
    ...
    def basic_optimizer_builder(named_param_groups):
        ...
        if optimizer_args.optimizer.name == "adamw":
        ...
        elif optimizer_args.optimizer.name == "sgd":
            ...
            raise ValueError(f"Optimizer {optimizer_args.optimizer.name} is not supported")
