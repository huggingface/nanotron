# NOTE: I moved it from helpers/llama.py to here to here for
# tests/{folder}/test_x.py to be able to import it
...
from nanotron.config.config import AdamWOptimizerArgs, PretrainDatasetsArgs
    ...
    return Config(
        ...
        optimizer=OptimizerArgs(
            optimizer_factory=AdamWOptimizerArgs(
                adam_eps=1e-08, adam_beta1=0.9, adam_beta2=0.95, torch_adam_is_fused=True, name="adamW"
            ),
            zero_stage=0,
            weight_decay=0.01,
            clip_grad=1.0,
