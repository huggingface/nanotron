...
from nanotron.nn.parallel.sharded_parameters import (
    SplitConfig,
    create_sharded_parameter_from_config,
    mark_all_parameters_in_module_as_sharded,
)
from nanotron.nn.parallel.tensor_parallelism.distributed_differentiable_primitives import (
...
from nanotron.nn.parallel.tensor_parallelism.functional import (
    column_linear,
    row_linear,
)
