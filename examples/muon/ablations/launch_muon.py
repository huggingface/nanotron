...
ALLOC = int(os.environ.get("ALLOC", 0))
...
CONFIG_PATH = "./configs"
LOGS_PATH = "./logs"
NANOTRON_FOLDER = "/fsx/nouamane/projects/nanotron"
...
if __name__ == "__main__":
    ...
    optimizer = OptimizerArgs(
        ...
        optimizer_factory=MuonOptimizerArgs(
            momentum=0.95,
            # beta3=0.9999,  # Added beta3 parameter
            # alpha=8.0,  # Added alpha parameter
            # beta3_warmup=100000,  # Using the same warmup steps as LR
            # alpha_warmup=100000,  # Using the same warmup steps as LR
            nesterov=False,
            ns_steps=5,
            adamw_beta1=0.9,
            adamw_beta2=0.95,
            adamw_eps=1e-8,
            spectral_mup_scaling=True,
            moonlight_scaling=False,
            sign_muon=False,
        ),
    )
