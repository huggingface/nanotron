...
torchrun --nproc_per_node=1 examples/mixtral/generate_mixtral.py --ckpt-path pretrained/mixtral
```
"""
...
import torch
from mixtral import MixtralConfig, MixtralForTraining
...
## MIXTRAL SPECIFIC
CONFIG_TO_MODEL_CLASS["MixtralConfig"] = MixtralForTraining
