...
CONFIG_FILE_106K=/capstor/scratch/cscs/lhuang/nanotron_climllama/climllama/configs/config_finetune_forecast_106k_continue.yaml
export CONFIG_FILE=${CONFIG_FILE_106K}
sbatch -N 48 -J finetune_climllama_forecast_106k run_finetune.sbatch
...
#sbatch -N 36 -J finetune_climllama_forecast_52k run_finetune.sbatch